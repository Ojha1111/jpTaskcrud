...
public class UserControllerTest {
    ...
    public void getUserByIdTest() {
        // Mock the service call
        when(userService.getUserById(1L)).thenReturn(Optional.of(new UserDTO(1L, "John Doe", "john@example.com")));
    ...
    public void updateUserTest() {
        ...
        // Mock the service call
        when(userService.updateUser(1L, userDTO)).thenReturn(Optional.of(new UserDTO(1L, "John Doe Updated", "john@example.com")));
